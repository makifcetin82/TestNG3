...
*/
    ...
    void  specialsValidation()
    {
        ...
        Assert.assertEquals(productList.size(),productList.size());//3. madde


   //eski fiyat yeni fiyat karsılastırması


        List<WebElement>newPriceList=driver.findElements(By.cssSelector("span[clas='price-new']"));
